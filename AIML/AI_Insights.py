...
def getInsights(query,context):
    ...
    prompt_template = """You are a Banking AI assistant. You have to answer user queries by utilizing the tools provided to you.
                ...
                3. If you need any additional information from the user:

                {"ask" : "ask the user to provide the required information"}
    ...
    if('fetch' in keys):
        ...
        getInsights(query, context= context + "\n" + data)
...
print(execute("SELECT * from customer where credit > 100"))